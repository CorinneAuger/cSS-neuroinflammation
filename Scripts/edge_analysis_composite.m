...
specific_folder_name = sprintf('/Users/corinneauger/Documents/Aiforia heatmap coregistration/Saved data/Edge analysis/%s %dum', stain, layer_width);
...
for brain = [1:3, 5, 7:9, 11, 13:15, 17:18, 20:25]
    for block = [1 4 5 7]
        ...
        variables_file = sprintf('CAA%d_%d_%s_and_Iron_density_comparison_crucial_variables.mat', brain, block, 'Iron');
